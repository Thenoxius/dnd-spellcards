...
const STR = {
  nl: {
    ...
    a6Hint: 'A6-modus: kies hieronder je papier. Op <b>A4</b> komen er 4 kaarten op een 2×2-snijvel; op <b>A6</b> of <b>10 × 15 cm</b> krijgt elke kaart een eigen pagina en hoef je niets te snijden. Zet in het printvenster <b>hetzelfde papierformaat</b> — 10 × 15 cm fotopapier is nét geen A6 (100 × 150 tegen 105 × 148 mm) en dan gaat de browser passend maken. Verder: <b>pagina\'s per blad: 1</b>, schaal <b>100%</b> (niet "passend maken"), marges <b>Geen</b>, en <b>kop- en voettekst uit</b>. De veiligheidsmarge hieronder is de rand die je printer niet kan bedrukken; kan hij randloos, zet hem dan op 0 mm.',
  ...
  en: {
    ...
    a6Hint: 'A6 mode: pick your paper below. On <b>A4</b> you get 4 cards on a 2×2 cutting sheet; on <b>A6</b> or <b>10 × 15 cm</b> every card gets its own page and there is nothing to cut. Set the <b>same paper size</b> in the print dialog — 10 × 15 cm photo paper is not quite A6 (100 × 150 vs 105 × 148 mm) and the browser will scale to fit. Also: <b>pages per sheet: 1</b>, scale <b>100%</b> (not "fit to page"), margins <b>None</b>, and switch <b>headers and footers off</b>. The safe margin below is the edge your printer cannot print on; set it to 0 mm if it prints borderless.',
